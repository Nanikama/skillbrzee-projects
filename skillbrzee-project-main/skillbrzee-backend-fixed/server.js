...
// ── Require DB for API routes (except health) ──────────────────────────────────
...
// ── Boot: start HTTP server first, then connect MongoDB (so server runs even without DB) ─
const PORT      = process.env.PORT || 5000;
const MONGO_URI = process.env.MONGO_URI || process.env.MONGODB_URI || 'mongodb://localhost:27017/skillbrzee';
