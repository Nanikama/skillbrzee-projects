...
/* Packages mirror (keep in sync with frontend PACKAGES array) */
const PACKAGES = [
  { id:1, name:'STARTER PACKAGE',  price: 50000  },  // in paise (₹500)
  { id:2, name:'BASIC PACKAGE',    price: 149900 },
  { id:3, name:'SILVER PACKAGE',   price: 299900 },
  { id:4, name:'GOLD PACKAGE',     price: 549900 },
  { id:5, name:'DIAMOND PACKAGE',  price: 999900 },
...
router.post('/create-order', protect, async (req, res) => {
  try {
    ...
    if (isDev && (!process.env.RAZORPAY_KEY_ID || process.env.RAZORPAY_KEY_ID.includes('XXXX'))) {
